...
To convert the interface.rnc to a file that xmllint can handle you can use
the trang converter:

   java -jar trang.jar -I rnc -O rng interface.rnc interface.rng
...
If you make any changes to the <tt>interface.rnc</tt> file, please send me the diffs!

Patrick Gundlach (patrick@gundla.ch) 7/2008
